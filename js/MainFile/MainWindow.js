...
//            },null,  this);
   this.game.physics.arcade.overlap(this.fishGroup, this.foodGroup, this._fishEatEvent, null, this);
    ...
    _fishEatEvent(fish, foodChip) {
        ...
        console.log('nomnom!');
            fish.hasEaten = true;
            this.game.time.events.add(Phaser.Timer.SECOND * 12, function () {fish.hasEaten = false;}, this);
        } else {
        ...
        _foodHandler() {
            ...
            _spawnFood() {
                if (this.game.time.now > this.foodSpawnTimer) {
                    ...
                    //            this.foodPosition.push(this.foodChip.x);
                    //            
                    //            
                    //            this.fishGroup.forEachAlive(function (fish, foodChip) {
                    //                fish.capturedX = this.foodChip.x;
                    //            }, this);
